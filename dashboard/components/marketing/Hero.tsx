  ...
  useGSAP(
    () => {
      ...
      tl.from(".hero-eyebrow", { opacity: 0, y: 12, duration: 0.5 })
        ...
        .from(".hero-gauge", { opacity: 0, scale: 0.92, duration: 0.7, ease: "power2.out" }, "-=0.5");
    },
    { scope: containerRef }
  );

  return (
    <section ref={containerRef} className="mx-auto max-w-6xl px-6 pb-20 pt-24 md:pt-32">
      <div className="grid items-center gap-12 md:grid-cols-2">
        <div>
          <p className="hero-eyebrow text-caption uppercase tracking-wide">Auth-as-a-Service, adaptive by default</p>
          ...
          <p className="hero-subhead text-body mt-4 max-w-md text-[var(--color-text-secondary)]">
            SentinelAuth runs every login through a real-time risk model — new device, impossible travel,
            credential stuffing — and only asks for MFA when it actually matters.
          </p>
